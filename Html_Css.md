...
### Responsive SVGs
Use media queries, remove details as screen gets smaller -> Infographic

## Animating SVG with CSS
we can only animate inline svg

### Transitioning svg properties
```
1) Add class to existing svg, 
<!-- GEAR -->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -50 400 200">
	<circle class="hammer-bg" fill="#39ADD1" cx="200" cy="50" r="90"></circle>
	<path class="hammer-icon" fill="#FFFFFF" d="M231.9,10.9c-1.8-0.6-3.6-0.6-5.1,0.3L216.2,17c-1.5-0.9-3-1.2-4.2-1.8l-3.1-11.5
...
2) change style on css transition
/*------
Hammer
------*/
.gear-bg{
...
![images](https://github.com/KennySoh/Technical-Interview/blob/master/oop/svg1.png)
```
.hammer-bg{
	stroke:#feee16e;
}
...
1. Find the components, jumbotron . 
https://getbootstrap.com/docs/4.0/components/jumbotron/ . 
  
2. changed color, bg-info and text-white   
3. change textalignment, text-sm-center . 
4. buttons and button groups 
```
<div class="jumbotron jumbtron-fluid bg-info">
